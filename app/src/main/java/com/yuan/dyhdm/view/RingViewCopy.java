...
/**
 * created by liangxuedong on 2021/6/16
 *
 ...
 */
public class RingViewCopy  extends View {
    ...
    public RingViewCopy(Context context) {
        super(context, null);
    }

    public RingViewCopy(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
...
//            float y = event.getY() - mViewCenterY;
            whichZone(event.getX(), event.getY());
        }
